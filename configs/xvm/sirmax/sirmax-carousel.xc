    ...
    "normal": {
      ...
      "extraFields": [
        ...
        { "y": 35, "height": 10, "bgColor": "0xFF4444", "alpha": "{{v.topdmg?30|0}}", "x": 5,
          "width": "{{py:mul({{py:div({{v.avgdmg}}, {{v.topdmg}})}}, 90)}}" },
        { "y": 35, "height": 10, "bgColor": "0x00FF00", "alpha": "{{v.topdmg?30|0}}",
          "x": "{{py:add(5, {{py:mul({{py:div({{v.avgdmg}}, {{v.topdmg}})}}, 90)}})}}",
          "width": "{{py:sub(90, {{py:mul({{py:div({{v.avgdmg}}, {{v.topdmg}})}}, 90)}})}}" },
        ...
        { "y": 33, "height": 14, "bgColor": "{{v.c_tdb}}", "alpha": "{{v.topdmg?100|0}}", "width": 1,
          "x": "{{py:add(5, {{py:min(90, {{py:mul({{py:div({{v.tdb|0}}, {{v.topdmg}})}}, 90)}})}})}}" },
        ...
        { "y": 50, "height": 10, "bgColor": "0xFF4444", "alpha": "{{v.topfrg?30|0}}", "x": 5,
          "width": "{{py:mul({{py:div({{v.avgfrg}}, {{v.topfrg}})}}, 90)}}" },
        { "y": 50, "height": 10, "bgColor": "0x00FF00", "alpha": "{{v.topfrg?30|0}}",
          "x": "{{py:add(5, {{py:mul({{py:div({{v.avgfrg}}, {{v.topfrg}})}}, 90)}})}}",
          "width": "{{py:sub(90, {{py:mul({{py:div({{v.avgfrg}}, {{v.topfrg}})}}, 90)}})}}" },
        ...
        { "y": 48, "height": 14, "bgColor": "{{v.c_tfb}}", "alpha": "{{v.topfrg?100|0}}", "width": 1,
          "x": "{{py:add(5, {{py:min(90, {{py:mul({{py:div({{v.tfb|0}}, {{v.topfrg}})}}, 90)}})}})}}" },
        ...
        { "y": 65, "height": 10, "bgColor": "0xFF4444", "alpha": "{{v.topdmg?30|0}}", "x": 5,
          "width": "{{py:mul({{py:div({{v.wn8expd}}, {{v.topdmg}})}}, 90)}}" },
        { "y": 65, "height": 10, "bgColor": "0x00FF00", "alpha": "{{v.topdmg?30|0}}",
          "x": "{{py:add(5, {{py:mul({{py:div({{v.wn8expd}}, {{v.topdmg}})}}, 90)}})}}",
          "width": "{{py:sub(90, {{py:mul({{py:div({{v.wn8expd}}, {{v.topdmg}})}}, 90)}})}}" },
        ...
        { "y": 63, "height": 14, "bgColor": "{{v.c_wn8effd}}", "alpha": "{{v.topdmg?100|0}}", "width": 1,
          "x": "{{py:add(5, {{py:min(90, {{py:mul({{v.wn8effd|0}}, {{py:div({{v.wn8expd}}, {{v.topdmg}})}}, 90)}})}})}}" },
        { "y": 61, "x": 20, "width": 75, "height": 22, "shadow": ${ "def.textFieldShadow" }, "alpha": "{{v.wn8effd?100|0}}",
          "format": "<font size='11' color='{{v.c_wn8effd}}'>{{py:mul({{v.wn8effd|0}}, 100)%d~%}}</font>" },
        // wins
