  ...
  "clock": {
    ...
    "formats": [
      ...
      },
      {
        ...
        "format": "<font face='$FieldFont'><textformat leading='-38'><font size='36'>{{py:xvm.formatDate('%H:%M')}}</font><br></textformat><textformat rightMargin='85' leading='-2'>{{py:xvm.formatDate('%A')}}<br><font size='15'>{{{{l10n:japan}}=日本?{{py:xvm.formatDate('%Y')}}年 {{py:xvm.formatDate('%m')}}月 {{py:xvm.formatDate('%d')}}日|{{py:xvm.formatDate('%d %b %Y')}}}}</font></textformat></font>"
      }
    ]
  },
  "statistics": {
