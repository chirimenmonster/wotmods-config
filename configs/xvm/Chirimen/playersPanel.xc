 ...
 */
{
  ...
  "playersPanel": {
    ...
    "short": {
      ...
      "nickFormatLeft": "<font size='13'><font face='mono' size='{{xvm-stat?13|0}}' color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{r}}</font> {{name%.{{anonym?13|15}}s~..}}{{anonym? <font face='xvm' size='13'>&#x11E;</font>}}<font alpha='#A0'>{{clan}}</font></font>",
      "nickFormatRight": "<font size='13'><font alpha='#A0'>{{clan}}</font>{{name%.15s~..}} <font face='mono' size='{{xvm-stat?13|0}}' color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{r}}</font></font>",
    ...
    "medium": {
      ...
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros_ru.txt).
      "nickFormatLeft": "<font size='13'><font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.{{anonym?23|{{clan?19|25}}}}s~..}}</font>{{anonym? <font face='xvm' size='13'>&#x11E;</font>}} <font alpha='#A0'>{{clan}}</font></font>",
      "nickFormatRight": "<font size='13'><font alpha='#A0'>{{clan}}</font> <font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.{{clan?{{battletype?16|19}}|{{battletype?22|25}}}}s~..}}</font> <font size='{{battletype?13|0}}'>{{position<10?&#x2002;}}[{{position}}]</font></font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
    ...
    "medium2": {
      ...
      // Display format for player nickname (macros allowed, see macros.txt).
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros_ru.txt).
      "nickFormatLeft": "<font size='13'><font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.{{anonym?10|12}}s~..}}</font>{{anonym? <font face='xvm' size='13'>&#x11E;</font>}} <font alpha='#A0'>{{clan}}</font></font>",
      "nickFormatRight": "<font size='13'><font alpha='#A0'>{{clan}}</font> <font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.12s~..}}</font></font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
      ...
      "extraFieldsLeft": [
        ...
        ${"def.xvmUserMarker"},
        ${"def.xmqpServiceMarker"},
        ${"def.hpIndicatorBG"}, ${"def.hpIndicator"}
      ],
      // Set of formats for right panel (extended format supported, see above).
      // Набор форматов для правой панели (поддерживается расширенный формат, см. выше).
      "extraFieldsRight": [
    ...
    "large": {
      ...
      // Display format for player nickname (macros allowed, see macros.txt).
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros_ru.txt).
      "nickFormatLeft": "<font size='13'><font face='mono' alpha='{{alive?#FF|#80}}'><font color='{{c:xr}}'>{{r}}</font> <font color='{{c:kb}}'>{{kb%2d~k|--k}}</font> <font color='{{c:winrate}}'>{{winrate%2d~%|--%}}</font></font> &#x2002;{{name%.{{anonym?14|{{clan?9|15}}}}s~..}}{{anonym? <font face='xvm' size='13'>&#x11E;</font>}} <font alpha='#A0'>{{clan}}</font></font>",
      "nickFormatRight": "<font size='13'><font alpha='#A0'>{{clan}}</font> {{name%.{{clan?{{battletype?6|9}}|{{battletype?12|15}}}}s~..}} <font size='{{battletype?13|0}}'>{{position<10?&#x2002;}}[{{position}}]</font> <font face='mono' alpha='{{alive?#FF|#80}}'> <font color='{{c:winrate}}'>{{winrate%2d~%|--%}}</font> <font color='{{c:kb}}'>{{kb%2d~k|--k}}</font> <font color='{{c:xr}}' >{{r}}</font> </font></font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
